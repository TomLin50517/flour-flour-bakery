...
- 頁首窄幅 banner + 分類 tab(錨點切換):**經典可頌/季節限定/常溫甜點**
- 產品卡:圖 4:5(圓角 12px)→ 品名 → 一句風味描述 → 玫瑰金價格 → 「每日限量 N 個」標籤(橄欖綠 badge);含酒精品項另加「含酒精」飲食標籤(銅色小 tag,與狀態標籤正交、隨語系在地化)
- 桌機 3 欄、平板 2 欄、手機 1 欄
- 產品資料結構(i18n JSON)含 `soldOut` 欄位:true 時卡片降飽和 + 「本日完售」badge(深可可)— v1 手動改 JSON,日後可接後台
- 虛構產品清單(融入品牌在地素材,實作時填入):
  - 經典可頌:開心果可頌 $120/原味可頌 $75/巧克力可頌 $95/龍眼蜜湯種吐司 $180/魯邦鄉村 $220/海鹽可頌 $68/全麥核桃 $190(可頌逐步取代非可頌品項,過渡中)
  - 季節:夕陽杏桃丹麥 $95/龍眼花蜜貝果 $85/無花果鄉村 $260/桂花栗子麵包 $110
  - 甜點:龍眼蜜瑪德蓮 $60/玫瑰荔枝達克瓦茲 $150/米粉戚風 $280/黑糖費南雪 $140/提拉米蘇 $160(含酒精)
